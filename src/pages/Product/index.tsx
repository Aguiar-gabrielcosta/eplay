  ...
  return (
    <>
      ...
      <Section title="Sobre o jogo" bgColor="black">
        <p>
          Hogwarts Legacy é um RPG de ação imersivo e de mundo averto ambientado
          ...
          poções, domine o lançamento de feitiços, aprimore taletos e torne-se o
      ...
      <Section title="Mais detalhes" bgColor="gray">
        <p>
          ...
          As opções de audio e legendas podem ser ajustadas nas configurações do
          jogo.
        </p>
      </Section>
